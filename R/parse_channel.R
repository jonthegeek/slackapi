...
.slack_response_channel_spec <- function() {
  tspec_df(
    ...
    channel_created_ts = tib_int("created"),
    tib_lgl("is_archived"),
    ...
    tib_row(
      ...
      tib_df(
        ...
        .required = FALSE,
        tabs_id = tib_chr("id"),
        tabs_label = tib_chr("label"),
        tabs_type = tib_chr("type"),
        tabs_data = tib_row(
          "data",
          .required = FALSE,
